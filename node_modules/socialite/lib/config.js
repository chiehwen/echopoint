module.exports = {
      facebook: {
        ...
        dialog: {
          ...
          mobile: "https://m.facebook.com/dialog/oauth?",
      ...
      twitter: {
        ...
        dialog: {
          ...
          access: "https://twitter.com/oauth/access_token?"
        },
        endpoint: {
          stream: {
      ...
      google: {
        root: 'https://www.googleapis.com/discovery/v1/',
        dialog: {
      ...
      bitly: {
        ...
        dialog: {
          auth: "https://bitly.com/oauth/authorize?"
        },
        oauth: {
          version: '2'
        }
